    ...
    public partial class adminpublishermanagement : System.Web.UI.Page
    {
        ...
        void getPublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from publisher_master_tb1where publisher_id='" + TextBox1.Text.Trim() + "';", con);
        ...
        public void updatePublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update publisher_master_tb1set publisher_name=@publisher_name WHERE publisher_id='" + TextBox1.Text.Trim() + "'", con);
                cmd.Parameters.AddWithValue("@publisher_name", TextBox2.Text.Trim());
        ...
        public void deletePublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Delete from publisher_master_tb1WHERE publisher_id='" + TextBox1.Text.Trim() + "'", con);
                int result = cmd.ExecuteNonQuery();
                con.Close();
                if (result > 0)
                {
